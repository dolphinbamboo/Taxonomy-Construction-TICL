...
class SinglePassCluster():
    def __init__(self, stopWords_path="/home/mengyuan/workDir/SeedTaxonomy/data/stop_words.txt", my_stopwords=None,
                 max_df=0.5, max_features=1000,
                 simi_threshold=0.5, res_save_path="/home/mengyuan/workDir/SeedTaxonomy/data/cluster_res.json"):
...
if __name__ == "__main__":
    test_data = "/home/mengyuan/workDir/SeedTaxonomy/data/test.txt"
